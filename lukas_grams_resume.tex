...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
	...
	{Geboren: 20.09.1994 in Düsseldorf}\\
  	{Wohnort: Rosenheim}\\
...
\resumeSubHeadingListStart
\item{
	\textbf{Bachelorarbeit (Fertigstellung August 2019)}{: 	\linebreak 
		Titel: "Attack vectors and security measures in enterprise-level Platform-as-a-Service solutions"}
}
\item{
...
\section{Ehrenamt}
  \resumeSubHeadingListStart
  	...
  	\resumeSubheading
  	{OWASP Studenten-Mitglied}{2018 - heute}
	...
	\resumeItemListStart
		\resumeItemWithoutHeadline
		{Bilaterale Interessensvertretung zwischen Studenten und Professoren}
		\resumeItemWithoutHeadline
		{Organisation von Informationsabenden, Festen und weiteren Aktionen}
	\resumeItemListEnd
	
	\resumeSubheading
	{Aktiver Mitarbeiter in zwei Jugendarbeits-Gremien}{2015 - 2017}
	...
	\resumeItemListStart
		...
		\resumeItemWithoutHeadline
		{Planen und Durchführen von Schulungen, Wochenend- und Tages-Aktionen}
	\resumeItemListEnd
